...
// Main class
public class RectangleReverseAlphabetPattern {
    ...
    public static void main(String[] args) {
        ...
        for (int row = 1; row <= rows; row++) {
            ...
            // Calculate the starting alphabet based on the number of columns
            char alphabet = (char) ('A' + columns - 1);

            // Inner loop controls the columns
            for (int column = 1; column <= columns; column++) {

                // Print the current alphabet followed by a space
